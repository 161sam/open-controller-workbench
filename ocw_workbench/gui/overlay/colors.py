...
OVERLAY_COLORS = {
    ...
    "surface_active": {"rgb": (0.26, 0.86, 0.92), "line_rgb": (0.06, 0.48, 0.64), "transparency": 82, "line_width": 4},
    "zone": {"rgb": (0.25, 0.85, 0.75), "line_rgb": (0.1, 0.55, 0.45), "transparency": 84},
    "placement_zone_idle": {"rgb": (0.78, 0.9, 0.98), "line_rgb": (0.26, 0.5, 0.72), "transparency": 88, "draw_style": "Dashdot", "line_width": 3},
    "placement_zone_hover": {"rgb": (0.66, 0.9, 1.0), "line_rgb": (0.14, 0.52, 0.82), "transparency": 78, "line_width": 5},
    "placement_zone_active": {"rgb": (0.38, 0.88, 0.78), "line_rgb": (0.08, 0.58, 0.44), "transparency": 72, "line_width": 6},
    "placement_zone_invalid": {"rgb": (0.98, 0.72, 0.38), "line_rgb": (0.82, 0.38, 0.08), "transparency": 70, "line_width": 6},
    "component": {"rgb": (0.7, 0.74, 0.78), "line_rgb": (0.35, 0.39, 0.45), "transparency": 70},
    "component_context": {"rgb": (0.86, 0.92, 0.98), "line_rgb": (0.36, 0.54, 0.72), "transparency": 52, "line_width": 4},
    "component_context_warning": {"rgb": (0.98, 0.9, 0.48), "line_rgb": (0.78, 0.58, 0.08), "transparency": 42, "line_width": 4},
    "component_context_error": {"rgb": (0.98, 0.68, 0.58), "line_rgb": (0.78, 0.24, 0.16), "transparency": 36, "line_width": 5},
    ...
    "component_selected_context": {"rgb": (0.2, 0.54, 1.0), "line_rgb": (0.08, 0.28, 0.74), "transparency": 14, "line_width": 6},
    "component_selected_secondary_context": {"rgb": (0.54, 0.82, 1.0), "line_rgb": (0.18, 0.48, 0.78), "transparency": 30, "line_width": 5},
    ...
    "component_manipulated": {"rgb": (0.1, 0.82, 0.66), "line_rgb": (0.04, 0.5, 0.38), "transparency": 12, "line_width": 7},
    "component_manipulated_warning": {"rgb": (0.96, 0.84, 0.28), "line_rgb": (0.74, 0.52, 0.08), "transparency": 18, "line_width": 7},
    "component_manipulated_error": {"rgb": (0.98, 0.54, 0.44), "line_rgb": (0.76, 0.16, 0.14), "transparency": 14, "line_width": 7},
    ...
    "preview_group_frame": {"rgb": (0.84, 0.94, 1.0), "line_rgb": (0.2, 0.5, 0.76), "transparency": 90, "draw_style": "Dashdot", "line_width": 3},
    "placement_context_group": {"rgb": (0.92, 0.96, 1.0), "line_rgb": (0.34, 0.52, 0.72), "transparency": 92, "draw_style": "Dashdot", "line_width": 2},
    "placement_context_link": {"rgb": (0.84, 0.92, 1.0), "line_rgb": (0.34, 0.52, 0.72), "transparency": 0, "draw_style": "Dashdot", "line_width": 2},
    ...
    "inline_action": {"rgb": (0.96, 0.98, 1.0), "line_rgb": (0.24, 0.34, 0.46), "transparency": 8, "line_width": 3},
    "inline_action_primary": {"rgb": (0.64, 0.88, 1.0), "line_rgb": (0.14, 0.46, 0.74), "transparency": 6, "line_width": 4},
    "inline_action_hover": {"rgb": (0.98, 0.9, 0.42), "line_rgb": (0.78, 0.54, 0.08), "transparency": 4, "line_width": 5},
    "inline_action_label": {"rgb": (0.12, 0.2, 0.3), "line_rgb": (0.12, 0.2, 0.3), "transparency": 0},
