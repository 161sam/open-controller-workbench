...
OVERLAY_COLORS = {
    ...
    "component_hover": {"rgb": (0.58, 0.84, 0.98), "line_rgb": (0.16, 0.49, 0.76), "transparency": 54, "line_width": 4},
    "component_hover_warning": {"rgb": (0.98, 0.83, 0.3), "line_rgb": (0.76, 0.53, 0.08), "transparency": 46, "line_width": 4},
    "component_hover_error": {"rgb": (0.97, 0.5, 0.42), "line_rgb": (0.72, 0.14, 0.14), "transparency": 38, "line_width": 5},
    "component_selected": {"rgb": (0.18, 0.47, 0.95), "line_rgb": (0.08, 0.23, 0.68), "transparency": 30, "line_width": 5},
    "component_selected_secondary": {"rgb": (0.34, 0.67, 0.96), "line_rgb": (0.14, 0.4, 0.72), "transparency": 46, "line_width": 4},
    ...
    "component_preview_warning": {"rgb": (0.95, 0.78, 0.22), "line_rgb": (0.76, 0.53, 0.08), "transparency": 72, "draw_style": "Dashdot"},
    "component_preview_error": {"rgb": (0.95, 0.38, 0.34), "line_rgb": (0.72, 0.14, 0.14), "transparency": 66, "draw_style": "Dashdot"},
    ...
    "preview_label": {"rgb": (0.94, 0.97, 1.0), "line_rgb": (0.15, 0.25, 0.4), "transparency": 0},
